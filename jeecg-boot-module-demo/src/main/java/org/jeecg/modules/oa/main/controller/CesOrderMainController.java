package org.jeecg.modules.oa.main.controller;
...
import org.jeecg.modules.oa.main.entity.CesOrderMain;
import org.jeecg.modules.oa.main.vo.CesOrderMainPage;
import org.jeecg.modules.oa.main.service.ICesOrderMainService;
...
@Api(tags="商城订单表")
@RestController
@RequestMapping("/main/cesOrderMain")
@Slf4j
public class CesOrderMainController {
    ...
    @RequiresPermissions("main:ces_order_main:add")
    ...
    @RequiresPermissions("main:ces_order_main:edit")
    ...
    @RequiresPermissions("main:ces_order_main:delete")
    ...
    @RequiresPermissions("main:ces_order_main:deleteBatch")
	...
	public Result<List<CesOrderGoods>> queryCesOrderGoodsListByMainId(@RequestParam(name="id",required=true) String id) {
	...
	public Result<List<CesOrderCustomer>> queryCesOrderCustomerListByMainId(@RequestParam(name="id",required=true) String id) {
    ...
    * @param cesOrderMain
    */
    @RequiresPermissions("main:ces_order_main:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("main:ces_order_main:importExcel")
