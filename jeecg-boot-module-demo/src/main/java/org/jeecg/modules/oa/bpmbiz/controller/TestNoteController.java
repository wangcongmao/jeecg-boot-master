package org.jeecg.modules.oa.bpmbiz.controller;
...
import org.jeecg.modules.oa.bpmbiz.entity.TestNote;
import org.jeecg.modules.oa.bpmbiz.service.ITestNoteService;
...
public class TestNoteController extends JeecgController<TestNote, ITestNoteService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "OA请假单-分页列表查询")
	@ApiOperation(value="OA请假单-分页列表查询", notes="OA请假单-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "OA请假单-添加")
	@ApiOperation(value="OA请假单-添加", notes="OA请假单-添加")
	@RequiresPermissions("bpmbiz:test_note:add")
	 ...
	 * @return
	 */
	@AutoLog(value = "OA请假单-编辑")
	@ApiOperation(value="OA请假单-编辑", notes="OA请假单-编辑")
	@RequiresPermissions("bpmbiz:test_note:edit")
	 ...
	 * @return
	 */
	@AutoLog(value = "OA请假单-通过id删除")
	@ApiOperation(value="OA请假单-通过id删除", notes="OA请假单-通过id删除")
	@RequiresPermissions("bpmbiz:test_note:delete")
	 ...
	 * @return
	 */
	@AutoLog(value = "OA请假单-批量删除")
	@ApiOperation(value="OA请假单-批量删除", notes="OA请假单-批量删除")
	@RequiresPermissions("bpmbiz:test_note:deleteBatch")
	 ...
	 * @return
	 */
	//@AutoLog(value = "OA请假单-通过id查询")
	@ApiOperation(value="OA请假单-通过id查询", notes="OA请假单-通过id查询")
    ...
    * @param testNote
    */
    @RequiresPermissions("bpmbiz:test_note:exportXls")
    @RequestMapping(value = "/exportXls")
    public ModelAndView exportXls(HttpServletRequest request, TestNote testNote) {
        return super.exportXls(request, testNote, TestNote.class, "OA请假单");
    }
    ...
    * @return
    */
    @RequiresPermissions("bpmbiz:test_note:importExcel")
